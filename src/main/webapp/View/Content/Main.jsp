<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <link href="${pageContext.request.contextPath}/css/Main_slider.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/css/swiper.css" rel="stylesheet">
     <link href="${pageContext.request.contextPath}/css/Top_content.css" rel="stylesheet">
		...
		<div class="top_content">
			...
			<div class="top_content_list">
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6">
					    <article class="content">
					      <a href="http://localhost:8090/boardspring9/View/Content/Content_watch.do?num=74" >
					            <div class=top_img>
					              <img src="${pageContext.request.contextPath}/picture/인기게시물/이미지3.jpg" alt="" class="img-rounded img-responsive">
					            </div><!-- top_img -->
					            <div class="text" >
                    ...
                    <!-- 두번째 게시물 -->
 					<div class="col-md-6 col-sm-6">
					    <article class="content">
					      <a href="http://localhost:8090/boardspring9/View/Content/Content_watch.do?num=75" >
					            <div class=top_img>
					              <img src="${pageContext.request.contextPath}/picture/인기게시물/인기게시물2.jpg" alt="" class="img-rounded img-responsive">
					            </div><!-- top_img -->
					            <div class="text">
				...
				<div class="row">
 					...
 					<div class="col-md-6 col-sm-6">
					    <article class="content">
					      <a href="http://localhost:8090/boardspring9/View/Content/Content_watch.do?num=73" >
					            <div class=top_img>
					              <img src="${pageContext.request.contextPath}/picture/인기게시물/인기게시물3.jpg" alt="" class="img-rounded img-responsive">
					            </div><!-- top_img -->
					            <div class="text">
					...
					<div class="col-md-6 col-sm-6">
					    <article class="content">
					      <a href="http://localhost:8090/boardspring9/View/Content/Content_watch.do?num=67" >
					            <div class=top_img>
					              <img src="${pageContext.request.contextPath}/picture/인기게시물/인기게시물4.jpg" alt="" class="img-rounded img-responsive">
					            </div><!-- top_img -->
					            <div class="text">
					...
					<div class="Slidewrap_sale col-md-12 col-sm-12">
	        		    ...
	        		    <ul class="sale_slider">
			              ...
			              <!--  https://www.ggumim.co.kr/furniture/view/83587  -->
			               <li><!-- 할인상품1 -->
			                 <a href="#">
			                	<img src="${pageContext.request.contextPath}/picture/아이템/할인상품1.jpg" alt="" >
				                <div class="text">
				                <h5>헬로우슬립</h5>
			               ...
			               <li><!-- 할인상품2 -->
			                 <a href="#">
			                	<img src="${pageContext.request.contextPath}/picture/아이템/할인상품2.jpg" alt="" >
				                <div class="text">
				                <h5>잉글랜더</h5>
			               ...
			               <li><!-- 할인상품3 -->
			                 <a href="#">
			                	<img src="${pageContext.request.contextPath}/picture/아이템/할인상품3.jpg" alt="" >
				                <div class="text">
				                <h5>리샘가구</h5>
			               ...
			               <li><!-- 할인상품4 -->
			                 <a href="#">
			                	<img src="${pageContext.request.contextPath}/picture/아이템/할인상품4.jpg" alt="" >
				                <div class="text">
				                <h5>쁘리엘르</h5>
			               ...
			               <li><!-- 할인상품5 -->
			                 <a href="#">
			                	<img src="${pageContext.request.contextPath}/picture/아이템/할인상품5.jpg" alt="" >
				                <div class="text">
				                <h5>레시앙뜨</h5>
			               ...
			               <li><!-- 할인상품6 -->
			                 <a href="#">
			                	<img src="${pageContext.request.contextPath}/picture/아이템/할인상품6.jpg" alt="" >
				                <div class="text">
				                <h5>마주팩토리</h5>
			               ...
			               <li><!-- 할인상품7 -->
			                 <a href="#">
			                	<img src="${pageContext.request.contextPath}/picture/아이템/할인상품7.jpg" alt="" >
				                <div class="text">
				                <h5>프시케</h5>
			              ...
			              <!--   https://www.ggumim.co.kr/furniture/view/114435 -->
			               <li><!-- 할인상품8 -->
			                 <a href="#">
			                	<img src="${pageContext.request.contextPath}/picture/아이템/할인상품8.jpg" alt="" >
				                <div class="text">
				                <h5>까사지오</h5>
			               ...
			               <li><!-- 할인상품9 -->
			                 <a href="#">
			                	<img src="${pageContext.request.contextPath}/picture/아이템/할인상품9.jpg" alt="" >
				                <div class="text">
				                <h5>하우스플랜</h5>
			               ...
			               <li><!-- 할인상품10 -->
			                 <a href="#">
			                	<img src="${pageContext.request.contextPath}/picture/아이템/할인상품10.png" alt="" >
				                <div class="text">
				                <h5>APLUM</h5>
