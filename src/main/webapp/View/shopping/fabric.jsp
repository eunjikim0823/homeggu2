...
String[] name = {"코지베어 먼지없는 차렵이불 단품 ", "호텔식 고밀도 바이오워싱 차렵이불 13종", "먼지없는 완벽 빛차단 암막커튼 1+1", "먼지없는 리버서블 차렵이불(SS/Q) 17종", "타일카페트", "토파즈 사각사각 고밀도 워싱 순면\n 60수 차렵이불 단품/세트", "집순이 선물 삼각 등쿠션 3type/3color/2size 순면 옥스포드 방수 솜포함 모찌 워싱 등받이쿠션", "못 없이 설치하자 안뚫어고리", "인디체크 사계절 순면 차렵이불 단품 및 세트 SS/Q/K/EK"};
String[] price = {"24,570", "61,800", "40,400", "29,500", "3,120", "44,100", "22,900", "7,000", "25,420"};
%>
<!DOCTYPE html>
<html>
<head>
		...
		for(int i = 0; i < img.length; i++) {
			...
			out.println("<td>");
				out.println("<table>");
					out.println("<tr align='center'>");
						out.println("<td>");
							out.println("<img src = 'images/fabric/" + img[i] + "' width='150' height='150' />");
						out.println("</td>");
					out.println("</tr>");
