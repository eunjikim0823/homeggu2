...
String[] name = {"선셋조명 스탠드/발리 석양 느낌 무드등(국내 인증제품)", "캠핑 인테리어 겸용 블루투스 스피커 LED 랜턴_3colors", "카라 부케 LED 무드등", "라이트 무선 충전 LED 센서등", "코니아일랜드 장스탠드 (화이트/3단조립형)", "스마트 라인 LED", "선라이즈 웨이크업 알람시계 무드등 취침등 수면등 조명", "튤립 부케 LED", "히든 LED 침대 조명"};
String[] price = {"36,900", "58,900", "34,900", "9,900 ", "37,000 ", "39,900", "32,700", "33,900", "12,900"};
%>
<!DOCTYPE html>
<html>
<head>
		...
		for(int i = 0; i < img.length; i++) {
			...
			out.println("<td>");
				out.println("<table>");
					out.println("<tr align='center'>");
						out.println("<td>");
							out.println("<img src = 'images/light/" + img[i] + "' width='150' height='150' />");
						out.println("</td>");
					out.println("</tr>");
