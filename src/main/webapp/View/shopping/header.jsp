  	...
  	<!-- 헤더영역------------------------------------------------- -->
	    	...
	    	<div class="container">
				<ul class="nav nav-tabs col-md-8 col-sm-8">
					<li class="icon"><a href="../WEB-INF/Main.jsp"><img src="./images/home.png" class="img-rounded img-responsive" width="50" height="50"></a></li>
					...
					<li class="store"><h2><a href="./index2.jsp">스토어</a></h2></li>
			   	</ul>
			   		 <!--검색창-->
