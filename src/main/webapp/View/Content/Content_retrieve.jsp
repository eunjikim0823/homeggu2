...
%>
	...
	<div class="contents_write col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
		...
		<form action="Content_update.do" method="post" enctype="multipart/form-data" >
		  ...
		  <!-- 	<input type="button" class="btn btn-warning btn-lg" value="대표사진 선택">
           ...
           <a href="Content_delete.do?num=<%= num %>" type="button" onclick="alert('글삭제가 완료되었습니다')" class="btn btn-danger btn-lg">삭제</a>
