...
String[] name = {"누워넥 목어깨 스트레칭 EMS 안마기","2IN1 접이식 다리미","클린스틱 초강력 BLDC 무선 핸디 청소기","포터블 블렌더 무선 믹서기 텀블러 S10","라인 슬리밍 종아리 공기압 마사지기","무선 물걸레청소기 자동물걸래 밀대","422 요리는장비빨 올스텐 대용량 에어프라이어 13L","최고급 세탁소용 보풀제거기 FX-500 전문가용 보플제거기","접이식 헤어드라이기 F600 3COLOR"};
String[] price = {"129,000 ", "39,800", "64,900 ", "29,800 ", "47,900 ", "198,000", "209,000", "42,900 ", "44,900"};
%>
<!DOCTYPE html>
<html>
<head>
		...
		for(int i = 0; i < img.length; i++) {
			...
			out.println("<td>");
				out.println("<table>");
					out.println("<tr align='center'>");
						out.println("<td>");
							out.println("<img src = 'images/electronics/" + img[i] + "' width='150' height='150' />");
						out.println("</td>");
					out.println("</tr>");
